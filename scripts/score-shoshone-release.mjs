...
const dimensions={
  ...
  visualEvidence:{weight:7,pass:/PS0N6ZlbiqQ/.test(html+api)&&/not live/.test(html.toLowerCase())},
  photography:{weight:5,pass:/PHOTO \+ RAINBOW WINDOW/.test(html)&&/rainbowStatus/.test(api)&&/mist/.test(api.toLowerCase())},
...
const hardVetoes={
  ...
  fakeCamera:!/PS0N6ZlbiqQ/.test(html),
  ...
  mobileContractMissing:!/@media\(max-width:760px\)/.test(css)
};
