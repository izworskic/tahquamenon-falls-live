...
import { inferVisitPreferences, inferMinutes, sanitizeClientState, deterministicResult } from '../api/visit-plan.js';
...
const clean = sanitizeClientState({ query:'Grandma, two kids, 90 minutes', minutes:480, preferences:['photo','bogus'] });
